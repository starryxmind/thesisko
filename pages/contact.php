...
<div class="container-fluid" id="reservation">
    <div class="page-header text-center">
        <h1 id="page-title">Send us mail</h1>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            <p class="text-justify">For any questions that you may have, please use the form below. An asterisk (*) indicates a required entry. Typical response time is 1-2 business days, depending on the nature of the question. Please note that we do not respond to form letters or e-mail campaigns.</p>
            <address>
                <strong>Grass Garden Resort and Hotel</strong><br>
                <span class="fa fa-map-pin"> Brgy. Sipat, Plaridel, Bulacan</span><br>
                <span class="fa fa-phone"> Tel no: (044) 795 0124</span> <br>
                <span class="fa fa-mobile-phone"> Cel no: 0915 193 1489</span> <br>
                <span class="fa fa-envelope"> E-mail: grassgardenph@yahoo.com</span>
            </address>
        </div>
        <div class="col-xs-12 col-sm-8 form-group">
            <form action="action/contact_action.php" class="form-horizontal">
                <div class="form-group">
                    <label for="CustomerName" class="col-xs-12 col-sm-2 control-label">*Name: </label>
                ...
                <div class="form-group">
                    <label for="EmailAddress" class="col-xs-12 col-sm-2 control-label">*E-mail: </label>
                    <div class="col-xs-12 col-sm-10">
                        <input type="text" class="form-control" id="EmailAddress" placeholder="Enter your E-mail Address">
                    </div>
                </div> <!--end of form group-->

                <div class="form-group">
                    <label for="ContactNumber" class="col-xs-12 col-sm-4 control-label">*Contact Number: </label>
                    <div class="col-xs-12 col-sm-10">
                ...
                <div class="form-group">
                    <label for="CustomerMsg" class="col-xs-12 col-sm-2 control-label">*Message: </label>
                    <div class="col-xs-12 col-sm-10">
                        <textarea name="user-msg" id="CustomerMsg" class="form-control" cols="20" rows="10" placeholder="enter your message here"></textarea>
                    </div>
                </div> <!--end of form group-->

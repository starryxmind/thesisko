    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="contact.php" id="color-menu">Contact Us</a>
                </li>
            </ul>
...
<div class="container-fluid" id="reservation">
    <div class="row" id="row-entrance">
        <!-- Swimming pool-->
        <div class="col-xs-12 col-sm-4">
            <h1 id="rates-label">Resort Entrance Fee</h1>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="page-header">
                <h3><strong>Day Time: </strong>8 AM to 4 PM</h3>
            </div>
            <br>
            <p><strong>Adult: </strong>PHP 200.00 / person</p>
            <p><strong>Children: </strong>PHP 150.00 / person (below 8 yrs old)</p>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="page-header">
                <h3><strong>Night Time: </strong>5 PM to 2 AM</h3>
            </div>
            <br>
            <p><strong>Adult: </strong>PHP 220.00 / person</p>
            <p><strong>Children: </strong>PHP 170.00 / person (below 8 yrs old)</p>
        </div>
    </div>
    <div class="row" id="row-services">
        <div class="col-xs-12 col-sm-12">
            <h1 id="rates-label">Services</h1>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-xs-12 col-sm-12">
            ...
            <div align="center">
                <img src="../images/rates/body-trtmnt.jpg" class="img-responsive" id="function-img">
            </div>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-xs-12 col-sm-3">
            ...
            <p>1 HOUR</p>
            <p><strong>PHP 350.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-3">
            <p>Back Massage</p>
            <p>1/2 HOUR</p>
            <p><strong>PHP 200.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-3">
            <p>Foot and Leg Massage</p>
            <p>1/2 HOUR</p>
            <p><strong>PHP 200.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-3">
    ...
    <div class="row text-center">
        <div class="col-xs-12 col-sm-12">
            ...
            <div align="center">
                <img src="../images/rates/Facial-treatments1.jpg" class="img-responsive" id="function-img">
                <br>
            </div>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-xs-12 col-sm-4">
            <p>Rejuvenating Facial Cleaning</p>
            <p><strong>PHP 250.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-4">
            <p>Facial Cleaning with GALVANIC</p>
            <p><strong>PHP 350.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-4">
            <p>Facial with DIAMOND PEEL</p>
            <p><strong>PHP 500.00</strong></p>
        </div>
    </div>
    <div class="row text-center" id="row-others">
        <div class="col-xs-12 col-sm-12">
            <br>
            <h3>OTHER SERVICES</h3>
            <div align="center">
                <img src="../images/rates/Eyelash-Perming-Grass-Garden-Resort.jpg" class="img-responsive" id="function-img">
                <br>
            </div>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-xs-12 col-sm-4">
            ...
            <p><strong>PHP 400.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-4">
            <p>Eyelash Perming</p>
            <p><strong>PHP 150.00</strong></p>
        </div>
        <div class="col-xs-12 col-sm-4">
            <p>Ear Candling</p>
            <p><strong>PHP 150.00</strong></p>
    ...
    <div class="row text-center">
        <div class="col-xs-12 col-sm-12">
            <div align="center">
                <img src="../images/rates/photoshoot.jpg" class="img-responsive" id="function-img">
                <br>
            </div>
            <p>PHOTOSHOOT</p>
            <p><strong>PHP 2,500.00</strong></p>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-12" align="center">
            <img src="../images/reminders.gif" class="img-responsive" id="reminder">
        </div>
    </div>
</div>
